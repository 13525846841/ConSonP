...
public class AsyncHttpResponseHandler {
    ...
    protected static final int PARSE_MESSAGE = 4;//解析消息
    public static final String KEY_FAIL = "error_message";
    ...
    public AsyncHttpResponseHandler(FragmentActivity activity) {
        this();
        if (activity != null) {
    ...
    public void onFailure(Throwable error, String content) {
        ...
        if (mActivityReference != null) {
            ...
            if (activity != null && !activity.isFinishing()) {
                if (error == null || error.getCause() instanceof ConnectException) {
