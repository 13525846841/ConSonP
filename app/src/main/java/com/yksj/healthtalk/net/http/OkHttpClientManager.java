...
public class OkHttpClientManager {
     ...
     * @param tag
     */
    public static void getAsyn(String url, String key, String values, ResultCallback callback, Object tag) {
     ...
     * @param tag
     */
    public static void getAsyn(String url, List<BasicNameValuePair> params, ResultCallback callback, Object tag) {
    ...
    private void deliveryResult(ResultCallback callback, Request request) {
        LogUtil.d("HEALTHTALK_HTTP", request.httpUrl().toString());
...
//            setCertificates(certificates, null, "qweQWEQWE123123");
        ...
        private Request buildMultipartFormRequest(String url, File[] files,
            ...
            for (Param param : params) {
                builder.addPart(Headers.of("Content-Disposition", "form-data; name=\"" + param.key + "\""),
                        RequestBody.create(MediaType.parse("text/plain;charset=utf-8"), param.value));//RequestBody.create(MediaType.parse("text/plain;charset=utf-8")
            }
            if (files != null) {
