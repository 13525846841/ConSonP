...
public class MessageThumbnailImageView extends RelativeLayout {
	...
	public Button imageDelete;//删除button
	public ImageView image;//


	public MessageThumbnailImageView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public MessageThumbnailImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void init(AttributeSet attrs){
		LayoutInflater.from(mcontext).inflate(R.layout.message_thumbnail_image_view, this,true);
