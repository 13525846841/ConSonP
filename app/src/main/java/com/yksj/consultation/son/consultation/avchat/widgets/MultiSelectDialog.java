...
import com.yksj.consultation.son.consultation.avchat.adapter.TAdapter;
import com.yksj.consultation.son.consultation.avchat.adapter.TAdapterDelegate;
import com.yksj.consultation.son.consultation.avchat.adapter.TViewHolder;
...
public class MultiSelectDialog extends Dialog {
    ...
    public void addPositiveButton(CharSequence title, int color, float size,
        ...
        positiveBtnTitle = TextUtils.isEmpty(title) ? "确定" : title;
