...
import com.yksj.consultation.son.consultation.avchat.widgets.Extras;
...
public class AVChatNotification {
    ...
    private void buildCallingNotification() {
        if (callingNotification == null) {
            ...
            int iconId = R.drawable.launcher_logo;
    ...
    private void buildMissCallNotification() {
        if (missCallNotification == null) {
            Intent notifyIntent = new Intent(context, PatientHomeActivity.class);
            Intent data = new Intent(context, WelcomeActivity.class);
