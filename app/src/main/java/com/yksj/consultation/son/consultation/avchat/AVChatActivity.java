...
import com.yksj.consultation.son.consultation.avchat.activity.AVChatExitCode;
import com.yksj.consultation.son.consultation.avchat.common.UI;
import com.yksj.consultation.son.consultation.avchat.constant.CallStateEnum;
import com.yksj.consultation.son.consultation.avchat.faceunity.FaceU;
import com.yksj.consultation.son.consultation.avchat.receiver.PhoneCallStateObserver;
import com.yksj.consultation.son.consultation.avchat.utils.VersionUtil;
...
import static com.yksj.consultation.comm.SingleBtnFragmentDialog.showDefault;
...
//        activeCallingNotifier();
    ...
    protected void onDestroy() {
        ...
        SharePreUtils.updateAvChateState(false);
    ...
    Observer<AVChatCalleeAckEvent> callAckObserver = new Observer<AVChatCalleeAckEvent>() {
        ...
        public void onEvent(AVChatCalleeAckEvent ackInfo) {
            ...
            if (LoginServiceManeger.instance().getLoginEntity() != null && LoginServiceManeger.instance().getLoginEntity().getAvData() != null) {
                LoginServiceManeger.instance().getLoginEntity().setAvData(null);
                SharePreUtils.updateAvChateState(false);
            }
    ...
    Observer<AVChatCommonEvent> callHangupObserver = new Observer<AVChatCommonEvent>() {
        ...
        public void onEvent(AVChatCommonEvent avChatHangUpInfo) {
            ...
            CoreService.removeActionVideo(AVChatActivity.this);
            AVChatSoundPlayer.instance().stop();
            avChatUI.closeRtc();
    ...
    private void outgoingCalling() {
        if (!HTalkApplication.getApplication().isNetWork()) { // 网络不可用
...
//                    showOrHideFaceULayout(true); // show
    ...
    public void onEventMainThread(VideoEvent event) {
        ...
        switch (code) {
            case VideoEvent.TIP:
                showDefault(getSupportFragmentManager(), "您的视频时间还有" + Long.valueOf(event.what) / 1000 + "秒");
                break;
//            case VideoEvent.END:
//                avChatUI.onHangUp();
//                break;
