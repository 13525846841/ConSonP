 ...
 * 初始订单详情_
 */
public class AtyOrdersDetails2 extends BaseFragmentActivity implements View.OnClickListener, PullToRefreshBase.OnRefreshListener<ScrollView> {
    ...
    private void delete() {
        ...
        HttpRestClient.OKHttpCaseInfo(pairs, new OkHttpClientManager.ResultCallback<String>() {
            @Override
...
//                                }
                                ...
                                for (int i = 0; i < picList.size(); i++) {
                                    ...
                                    String url = HTalkApplication.getHttpUrls().URL_QUERYHEADIMAGE_NEW + picList.get(i).optString("SMALL_PICTURE");
                                    Picasso.with(AtyOrdersDetails2.this).load(url).placeholder(R.drawable.waterfall_default).into(img);
...
//                                        mImageLoader.displayImage(thumbnail, img, mOptions);
                                        String url = HTalkApplication.getHttpUrls().URL_QUERYHEADIMAGE_NEW + thumbnail;
                                        Picasso.with(AtyOrdersDetails2.this).load(url).placeholder(R.drawable.waterfall_default).into(img);
                                    } else {
...
//                                            startActivity(i);
    ...
    public void onBackPressed() {
        if (getIntent().hasExtra("BACK")) {
            ...
            if (backMain == 2) {
                Intent intent = new Intent(AtyOrdersDetails2.this, AtyMyOrders.class);
