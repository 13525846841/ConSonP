package com.yksj.consultation.son.consultation.avchat.imageview;
...
public class HeadImageView extends CircleImageView {
    ...
    public void loadTeamIconByTeam(final Team team) {
        doLoadImage(team != null ? team.getIcon() : null, R.drawable.default_head_doctor, DEFAULT_AVATAR_THUMB_SIZE);
    }
