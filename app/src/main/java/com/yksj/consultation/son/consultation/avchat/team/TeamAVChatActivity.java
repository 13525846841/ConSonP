...
import com.yksj.consultation.son.consultation.avchat.AVChatSoundPlayer;
...
import com.yksj.consultation.son.consultation.avchat.team.input.BaseFetchLoadAdapter;
...
import static com.yksj.consultation.son.consultation.avchat.team.TeamAVChatItem.TYPE.TYPE_DATA;
...
public class TeamAVChatActivity extends UI {
    ...
    private void showDialog() {
        DoubleBtnFragmentDialog.showDefault(getSupportFragmentManager(), "已经没有人在房间了，您确定要挂断吗？", "取消", "确定",
...
////        adapter.notifyItemChanged(1);
    ...
    private void changeView(View view, final int position) {
        try {
            ...
            selfItem.state = TeamAVChatItem.STATE.STATE_PLAYING; // 自己直接采集摄像头画面
            if (LoginServiceManeger.instance().getLoginEntity() == null) return;
            String myCount = LoginServiceManeger.instance().getLoginEntity().getSixOneAccoutn();
