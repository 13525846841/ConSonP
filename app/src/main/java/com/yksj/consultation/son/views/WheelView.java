...
import com.yksj.consultation.adapter.WheelAdapter;
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xD0111111;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xDD111111;
	...
	private static final int ADDITIONAL_ITEM_HEIGHT = 18; //间距
	...
	private static int ADDITIONAL_ITEMS_SPACE = 1000;

	/** Label offset */
	private static final int LABEL_OFFSET = 8;

	/** Left and right padding value */
	private static final int PADDING = 10; //横--字间距

	/** Default count of visible items */
	private static int DEF_VISIBLE_ITEMS = 5;
	...
	private void initData(Context context) {
		...
		TEXT_SIZE = (int)(20*den);
		//ADDITIONAL_ITEMS_SPACE = (int)(den*ADDITIONAL_ITEMS_SPACE);
		//ITEM_OFFSET = TEXT_SIZE/visibleItems;
		if(den >=1.5){
			DEF_VISIBLE_ITEMS = 7;
	...
	public void setAdapter(WheelAdapter adapter) {
		...
		if(adapter.getItemsCount() < visibleItems)
			visibleItems = DEF_VISIBLE_ITEMS;
		invalidateLayouts();
		invalidate();
	}
	...
	private void createLayouts(int widthItems, int widthLabel) {
		...
		if (!isScrollingPerformed
			...
			valueLayout = null;
//			/* 增加了 滚轮音效 */
//			RingMediaPlayerUtil.play(getContext(),
//					RingMediaPlayerUtil.RING_WHEEL);
		} else {
