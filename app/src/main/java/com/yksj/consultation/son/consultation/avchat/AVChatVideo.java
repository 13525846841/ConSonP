...
public class AVChatVideo implements View.OnClickListener, ToggleListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.receive:
                listener.onReceive();
                CoreService.setActionVideoTip(context,0L,0);
                break;
    ...
    private void showDialog() {
        DoubleBtnFragmentDialog.showDefault(activity.getSupportFragmentManager(), "您确定要挂断吗？", "取消", "确定",
...
//											}
                    ...
                    public void onClick(DialogFragment fragment, View v) {
                        listener.onHangUp();
                        CoreService.removeActionVideo(context);
                    }
                });
    }
}
