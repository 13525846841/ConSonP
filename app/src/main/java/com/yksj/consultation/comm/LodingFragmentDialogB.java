...
public class LodingFragmentDialogB extends DialogFragment {
	 ...
	 * @param content 文字内容
	 */
	public static LodingFragmentDialogB showLodingDialog(FragmentManager manager, String content){
		if(!manager.isDestroyed()){
			...
			LodingFragmentDialogB dialog = LodingFragmentDialogB.newInstance(content);
	 ...
	 * @param resources
	 */
	public static LodingFragmentDialogB showLodingDialog(FragmentManager manager, Resources resources){
	...
	static LodingFragmentDialogB newInstance(String content){
		LodingFragmentDialogB dialog = new LodingFragmentDialogB();
