 ...
 */
public class SixOneThirdPopupAdapter extends BaseAdapter {
    private LayoutInflater mInflater;//得到一个LayoutInfalter对象用来导入布局
    private Context context;
    private List<JSONObject> list = new ArrayList<JSONObject>();

    public SixOneThirdPopupAdapter( Context context) {
        this.list = list;
    ...
    public String getName3(int position){
        return list.get(position).optString("CLASS_NAME");
    }
    public String getClass_id3(int position){
