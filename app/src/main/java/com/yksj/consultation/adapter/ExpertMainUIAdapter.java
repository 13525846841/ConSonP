 ...
 */
public class ExpertMainUIAdapter extends SimpleBaseAdapter<DoctorSimpleBean> {
    ...
    public ExpertMainUIAdapter(Context context, int type) {
        super(context);
    ...
    public View getItemView(final int position, View convertView,
       ...
       // TextView tvSpecial=(TextView) convertView.findViewById(R.id.select_expert_list_item_spetical);
        ...
        TextView tvOffice = (TextView) convertView.findViewById(R.id.select_expert_list_item_office);
        ...
        if (!HStringUtil.isEmpty(doctorSimple.getDOCTOR_HOSPITAL())){
            tvHospital.setText(doctorSimple.getDOCTOR_HOSPITAL());
        }else {
            tvHospital.setVisibility(View.GONE);
        }
        tvHospital.setText(doctorSimple.getDOCTOR_HOSPITAL());
        tvOffice.setText(doctorSimple.getOFFICE_NAME());

        tvRemainNum.setText("擅长:"+doctorSimple.getDOCTOR_SPECIALLY());
