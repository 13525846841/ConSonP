...
import com.yksj.consultation.son.BuildConfig;
...
public final class ImageLoaderConfiguration {
	...
	final String downRootUrlPath;//下载根路径
...
//		downRootUrlPath = HTalkApplication.getHttpUrls().URL_QUERYHEADIMAGE;//下载根路径
		downRootUrlPath = HTalkApplication.getHttpUrls().URL_QUERYHEADIMAGE_NEW;//下载根路径
	...
	public static class Builder {
		 ...
		 */
		private Builder discCacheExtraOptions(int maxImageWidthForDiscCache, int maxImageHeightForDiscCache, CompressFormat compressFormat, int compressQuality) {
		 ...
		 * {@link org.universalimageloader.cache.memory.impl.UsingFreqLimitedMemoryCache UsingFreqLimitedCache}
		 ...
		 * Default value - {@link org.universalimageloader.cache.memory.impl.UsingFreqLimitedMemoryCache
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link org.universalimageloader.cache.disc.impl.TotalSizeLimitedDiscCache TotalSizeLimitedDiscCache}
		 ...
		 * By default: disc cache is unlimited.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link org.universalimageloader.cache.disc.impl.FileCountLimitedDiscCache FileCountLimitedDiscCache}
		 * will be used as disc cache. You can use {@link #discCache(DiscCacheAware)} method for introduction your own
		 * implementation of {@link DiscCacheAware}
		 */
		 ...
		 * Default value -
		 * {@link org.universalimageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		 ...
		 * Default value -
		 * {@link org.universalimageloader.core.DefaultConfigurationFactory#createImageDownloader()
		 ...
		 * Default value - {@link org.universalimageloader.cache.disc.impl.UnlimitedDiscCache
		 * UnlimitedDiscCache}. Cache directory is defined by <b>
		 * {@link org.universalimageloader.utils.StorageUtils#getCacheDirectory(Context)
		...
		public Builder enableLogging() {
			this.loggingEnabled = BuildConfig.DEBUG;
			return this;
		}

		/** 建立配置信息Builds configured {@link ImageLoaderConfiguration} object */
		public ImageLoaderConfiguration build() {
			initEmptyFiledsWithDefaultValues();
			return new ImageLoaderConfiguration(this);
		}
		
		public void setMemoryCache(boolean flag){
		}

		private void initEmptyFiledsWithDefaultValues() {
			if (discCache == null) {
				if (discCacheFileNameGenerator == null) {
					discCacheFileNameGenerator = DefaultConfigurationFactory.createHtttpNameGenerator();
				}
			...
			if (defaultDisplayImageOptions == null) {
				defaultDisplayImageOptions = DisplayImageOptions.createSimple(context);
			}
		}
	}
}
